    ...
    <div class="auto-container">
      <div class="row clearfix">
        ...
        <div class="content-side col-lg-8 col-md-12 col-sm-12">
          <div class="blog-posts">
            ...
            <div class="news-block-two">
              <div class="inner-box">
                ...
                <div class="lower-box">
                  ...
                  <h4>
                    <NuxtLink to="/blog-single"
                      >basic rules of running web agency business</NuxtLink
                    >
                  </h4>
                  <div class="text">
                  ...
                  <div class="link-box">
                    <NuxtLink class="theme-btn" to="/blog-single"
                      >Read More</NuxtLink
                    >
                  </div>
                </div>
            ...
            <div class="news-block-two">
              <div class="inner-box">
                ...
                <div class="lower-box">
                  ...
                  <h4>
                    <NuxtLink to="/blog-single"
                      >Delivering the best digital marketing</NuxtLink
                    >
                  </h4>
                  <div class="text">
                    There are many variations of passages of Lorem Ipsum
            ...
            <div class="news-block-two">
              <div class="inner-box">
                ...
                <div class="lower-box">
                  ...
                  <h4>
                    <NuxtLink to="/blog-single"
                      >Introducing the latest mediaara features</NuxtLink
                    >
                  </h4>
                  <div class="text">
                    There are many variations of passages of Lorem Ipsum
            ...
            <div class="news-block-three">
              <div class="inner-box">
                ...
                <NuxtLink to="/blog-single" class="over-link"></NuxtLink>
              </div>
            </div>
            ...
            <div class="news-block-three">
              <div class="inner-box">
                <div class="link-icon">
                  <span class="flaticon-link-2"></span>
                </div>
                <h4>
                  <NuxtLink to="/blog-single"
                    >Delivering the best digital marketing</NuxtLink
          ...
          <div class="more-box">
            <NuxtLink class="theme-btn btn-style-one" to="/blog.html">
              <i class="btn-curve"></i>
